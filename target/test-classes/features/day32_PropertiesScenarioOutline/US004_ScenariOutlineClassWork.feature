...
Feature: US004 DataTables Testi
  ...
  Scenario Outline: TC01 DataTables Veri Girisi
    ...
    And cikan pencerede verilen bilgiler girilir "<firstname>","<lastname>","<position>","<office>","<extention>","<date>","<salary>"
    And kullanici 2 saniye bekler
    And kullanici create butonuna basar
    And kullanici 2 saniye bekler
    And kullanici search bolumune "<firstname>" bilgisini girer.
    And kullanici 2 saniye bekler
    And kullanici "<firstname>" ile basarili giris yapildgini dogrular
    And kullanici 2 saniye bekler
    And sayfayi kapatir
    Examples:
